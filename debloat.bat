...
adb shell pm disable-user --user 0 com.facebook.apadb shell pmanager
...
adb shell pm disable-user --user 0 com.microsoft.apadb shell pmanager
...
#adb shell pm enable --user 0 com.nuance.swype.input
#adb shell pm disable-user --user 0 com.osp.app.signin
#adb shell pm enable --user 0 com.osp.app.signin
...
adb shell pm disable-user --user 0 com.samsung.android.app.advsounddetector
...
adb shell pm disable-user --user 0 com.samsung.android.app.filterinstaller
...
adb shell pm disable-user --user 0 com.samsung.hs20provider
...
adb shell pm disable-user --user 0 com.sec.android.app.bluetoothtest
...
#adb shell pm enable --user 0 com.sec.android.app.clockpackage
...
#adb shell pm enable --user 0 com.sec.android.app.popupcalculator
adb shell pm disable-user --user 0 com.sec.android.app.quicktool
adb shell pm disable-user --user 0 com.sec.android.app.ringtoneBR
...
adb shell pm disable-user --user 0 com.sec.android.app.SmartClipEdgeService
adb shell pm disable-user --user 0 com.sec.android.app.soundalive
adb shell pm disable-user --user 0 com.sec.android.app.sysscope
adb shell pm disable-user --user 0 com.sec.android.app.tfunlock
adb shell pm disable-user --user 0 com.sec.android.app.tourviewer
...
adb shell pm disable-user --user 0 com.sec.android.app.wfdbroker
...
#adb shell pm enable --user 0 com.sec.android.daemonapp
adb shell pm disable-user --user 0 com.sec.android.desktoadb shell pmode.uiservice
...
adb shell pm disable-user --user 0 com.sec.android.ofviewer
adb shell pm disable-user --user 0 com.sec.android.omc
adb shell pm disable-user --user 0 com.sec.android.Preconfig
...
adb shell pm disable-user --user 0 com.sec.android.providers.security
adb shell pm disable-user --user 0 com.sec.android.providers.tasks
...
adb shell pm disable-user --user 0 com.sec.app.TransmitPowerService
adb shell pm disable-user --user 0 com.sec.automation
adb shell pm disable-user --user 0 com.sec.bcservice
adb shell pm disable-user --user 0 com.sec.downloadablekeystore
...
adb shell pm disable-user --user 0 com.sec.mldapchecker
...
adb shell pm disable-user --user 0 com.sec.smartcard.manager
adb shell pm disable-user --user 0 com.sec.spen.flashannotate
...
adb shell pm disable-user --user 0 com.yelp.android.samsungedge

adb shell pm disable-user --user 0 comflipboard.app
adb shell pm disable-user --user 0 comflipboard.boxer.app

adb shell pm disable-user --user 0 comtv.peel.samsung.app
